...
_pat:
	.DB  0x0,0x0,0x0,0x80,0x0,0x80,0x80,0x40
	.DB  0x80,0x40,0x40,0x20,0x40,0x20,0x20,0x10
	.DB  0x20,0x10,0x10,0x8,0x10,0x8,0x8,0x4
	.DB  0x8,0x4,0x4,0x2,0x4,0x2,0x2,0x1
	.DB  0x2,0x1,0x1,0x0,0x1,0x0,0x0,0x0
...
_0x3:
; 0000 0027 
; 0000 0028        for(row = 0; row < 10; row++){
	CLR  R6
	CLR  R7
_0x7:
	LDI  R30,LOW(10)
...
; 0000 002A         if(row == 4){
	...
	CPC  R31,R7
	BRNE _0x9
; 0000 002B             delayTime = 5;
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	RJMP _0xF
; 0000 002C         } else {
_0x9:
; 0000 002D             delayTime = 1;
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
_0xF:
	MOVW R4,R30
; 0000 002E         }
; 0000 002F 
; 0000 0030         for(col = 0; col < 25 * delayTime ; col++){
	CLR  R8
	CLR  R9
_0xC:
	MOVW R30,R4
	...
	CPC  R9,R31
	BRGE _0xD
; 0000 0031             PORTB=pat[row][0];
	RCALL SUBOPT_0x0
	RCALL SUBOPT_0x1
; 0000 0032             PORTA=0b11100111;
; 0000 0033             delay_ms(10);
; 0000 0034 
; 0000 0035             PORTB=pat[row][1];
	RCALL SUBOPT_0x0
	ADIW R30,1
	LPM  R0,Z
	OUT  0x18,R0
; 0000 0036             PORTA=0b11101111;
	LDI  R30,LOW(239)
	RCALL SUBOPT_0x2
; 0000 0037             delay_ms(10);
; 0000 0038 
; 0000 0039             PORTB=pat[row][2];
	ADIW R30,2
	LPM  R0,Z
	OUT  0x18,R0
; 0000 003A             PORTA=0b11011111;
	LDI  R30,LOW(223)
	RCALL SUBOPT_0x2
; 0000 003B             delay_ms(10);
; 0000 003C 
; 0000 003D             PORTB=pat[row][3];
	ADIW R30,3
	RCALL SUBOPT_0x1
; 0000 003E             PORTA=0b11100111;
